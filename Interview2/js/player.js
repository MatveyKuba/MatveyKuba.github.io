    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="34" height="34" data-play="playable" class="not-started playable">',
                '<g class="shape">',
                '<circle class="progress-track" cx="50" cy="50" r="47.45" stroke="#becce1" stroke-opacity="0.25" stroke-linecap="round" fill="none" stroke-width="3"/>',
                ...
                '<circle class="progress-bar" cx="50" cy="50" r="47.45" stroke="white" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="2" transform="rotate(-90 50 50)"/>',
                '</g>',
