    ...
    var _ = {
        ...
        init: function (options) {
           ...
           ' <stop offset="0%" stop-color="black" class="stop-1"/>',
            '<stop offset="75%" stop-color="#1C1C1C" class="stop-2"/>',
         ...
         '</linearGradient>',
                ...
                '<circle class="progress-bar" cx="50" cy="50" r="47.45" stroke="#6A8A9A" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="2" transform="rotate(-90 50 50)"/>',
                '</g>',
