...
(function ($) {
    ...
    var _ = {
        ...
        init: function (options) {
           ...
           ' <stop offset="0%" stop-color="black" class="stop-1"/>',
            '<stop offset="50%" stop-color="black" class="stop-2"/>',
            '<stop offset="51%" stop-color="1C1C1C" class="stop-2"/>',
            '<stop offset="63%" stop-color="1C1C1C" class="stop-3"/>',
            '<stop offset="90%" stop-color="#202020" class="stop-4" />',
            '<stop offset="100%" stop-color="#202020" class="stop-5" />',
           ' </radialGradient>',
                '<g class="shape">',
                '<circle class="progress-track" cx="50" cy="50" r="47.45" stroke="#becce1" stroke-opacity="0.25" stroke-linecap="round" fill="url(#grad)" stroke-width="3"/>',
                '<circle class="precache-bar" cx="50" cy="50" r="47.45" stroke="grey" stroke-opacity="0.75" stroke-linecap="round" fill="none" stroke-width="3" transform="rotate(-90 50 50)"/>',
                '<circle class="progress-bar" cx="50" cy="50" r="47.45" stroke="black" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="2" transform="rotate(-90 50 50)"/>',
                '</g>',
                '<circle class="controls" cx="50" cy="50" r="45" stroke="none" fill="white" opacity="0.0" pointer-events="all"/>',
                '<g class="control pause">',
                '<line x1="40" y1="35" x2="40" y2="65" stroke="white" fill="white" stroke-width="8" stroke-linecap="round"/>',
                '<line x1="60" y1="35" x2="60" y2="65" stroke="white" fill="white" stroke-width="8" stroke-linecap="round"/>',
                '</g>',
                '<g class="control play">',
                '<polygon points="45,35 65,50 45,65" fill="white"  stroke-width="1"></polygon>',
                '</g>',
                '<g class="control stop">',
                '<rect x="35" y="35" width="30" height="30" stroke="#000000" fill="white" stroke-width="1"/>',
                '</g>',
                '</svg>'];
