    ...
    var _ = {
        ...
        init: function (options) {
           ...
           ' <stop offset="0%" stop-color="black" class="stop-1"/>',
            ...
            '<stop offset="51%" stop-color="black" class="stop-2"/>',
            '<stop offset="63%" stop-color="black" class="stop-3"/>',
            '<stop offset="100%" stop-color="rgba(255, 255, 255, 15)" class="stop-4" style="filter: blur(38px)"/>',
           ' </radialGradient>',
                '<g class="shape">',
                ...
                '<circle class="precache-bar" cx="50" cy="50" r="47.45" stroke="#302F32" stroke-opacity="0.25" stroke-linecap="round" fill="none" stroke-width="3" transform="rotate(-90 50 50)"/>',
